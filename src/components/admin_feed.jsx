 ...
 return true;
    ...
    console.log(this.state)
     ...
     let newTeams = teams.map(team=>{
        ...
        console.log({...challenge,data:challenge.teamsCompleted[team]})
        
        if(challenge.teamsCompleted[team]){
        
        allChallenges.push({...challenge, ...challenge.teamsCompleted[team]});
    ...
    this.setState({teams:newTeams, loading:false})
   //this.setState(teams);
...
getPoints(teamId, points) {
    ...
    render(){
      ...
      >
             <Typography align="center" variant="headline">Admin Feed</Typography>
             <br/>
             <div>
             ...
             <br/>
             <Typography align="center"  color="secondary" variant="title" gutterBottom style={{marginTop:"10px"}}>{team[0]?team[0].teamName:""}</Typography>
    ...
    <CardTitle title="Clue" subtitle={tile.clue} />
<CardActions>

            <form  id={tile.key+"<><>"+tile.teamId}  onSubmit={this.handleRemove} >
             <FlatButton
